        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo htmlspecialchars($footer_base_path . 'pages/subjects.php', ENT_QUOTES, 'UTF-8'); ?>">Subjects</a></li>
                    <?php endif; ?>
                    <?php if (function_exists('canManageTeachers') && canManageTeachers()): ?>
                    <li><a href="<?php echo htmlspecialchars($footer_base_path . 'pages/teachers.php', ENT_QUOTES, 'UTF-8'); ?>">Teachers</a></li>
                    <?php endif; ?>
            ...
            <div class="footer-section">
                <h4>System</h4>
                <p>Role-based access keeps admin, teachers, homeroom teachers, and students inside their correct workflow.</p>
            </div>
            <div class="footer-section">
                <h4>Version</h4>
